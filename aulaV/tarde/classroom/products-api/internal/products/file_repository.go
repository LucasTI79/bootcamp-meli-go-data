...
func (r *FileRepository) GetFullData(id uint64) (entities.ProductFullData, error) {
	return entities.ProductFullData{}, nil
}

func (r *FileRepository) GetOneWithContext(ctx context.Context, id uint64) (entities.Product, error) {
	return entities.Product{}, nil
}
